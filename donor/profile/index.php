	...
	<div class="container-row donor">
        ...
        <div class="main">
            ...
            <div class="form-row" style="margin-left: 25%;">
                ...
                <?php
                    echo "<a class=\"check\" style=\"color: green;\" href=\"edit_donor.php?nic=$NIC\" onclick=\"return confirm('Are you sure to Edit?')\">Edit</a>";
                ?>
                </div>
                <div class="form-group">
                <?php
                   echo "<a class=\"check\" style=\"color: red;\" href=\"delete.php?nic=$NIC\" onclick=\"return confirm('Warning! : This Cannot be undone... If you proceed, your all data will be lost. (cannot be recover)')\">Delete</a>"; 
                ?>
                </div>
            </div> 
