...
<body>
	<div class="form-style-2-heading">
		<h1><center>Organization Login</center></h1>
	</div>

	<center>
		<div id="SuperAdmin" class="tabcontent">
			<div class="form-style-2">
				<div class="form-style-2-heading">Welcome Organization !</div>
					<form action="application/reg_login.php" method="post">
						...
						<label><input type="submit" name="organization" class="btn btn-primary" value="Login"></label><br>
						
					</form>
					<a href="../reset/enter_email.php?type=organization">Forgot Password?</a>
			</div>
